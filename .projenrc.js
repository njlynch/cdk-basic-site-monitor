...
const project = new ConstructLibraryAws({
  author: 'Nick Lynch',
  authorAddress: 'njlynch@gmail.com',
  cdkVersion: '2.0.0-alpha',
  defaultReleaseBranch: 'main',
  jsiiFqn: 'njlynch.BasicSiteMonitor',
  name: 'cdk-basic-site-monitor',
  repositoryUrl: 'https://github.com/njlynch/cdk-basic-site-monitor.git',
  cdkAssert: false,
